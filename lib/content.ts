...
export const resourceCopy: Record<Lang, ResourceCopy> = {
  ko: {
    ...
    sectionSubtitle: '블로그를 따로 벌리지 않고, 감정 일기 사용 맥락과 11가지 감정 카테고리를 중심으로 읽을 거리를 연결합니다.',
    featuresLabel: '기능 가이드 6개',
    featuresDescription: 'AI 채팅 일기, 사진 일기, 일기변환, 글 교정, 대체 어휘 추천, 스티커 꾸미기처럼 검색 의도가 뚜렷한 기능별 안내 페이지입니다.',
    featuresCta: '기능 자세히 보기',
    guidesLabel: '가이드 5개',
    guidesDescription: '시작법, 템플릿, 무감각한 날 기록법, 사진 일기, 주간 리뷰까지 앱 사용 상황과 바로 연결되는 안내 페이지입니다.',
    guidesCta: '가이드 보기',
    emotionsLabel: '감정 사전 11개',
    emotionsDescription: '기쁨, 감사, 만족, 외로움, 불안 같은 감정을 구분하고 기록하는 방법을 정리한 사전형 페이지입니다.',
  ...
  en: {
    ...
    emotionsLabel: '11 Emotion Entries',
    emotionsDescription: 'Dictionary-style pages explain how to tell joy, gratitude, satisfaction, loneliness, anxiety, and other emotions apart in a diary entry.',
  ...
  ja: {
    ...
    sectionSubtitle: '独立したブログではなく、感情日記の使い方と11の感情カテゴリに沿ったガイドを用意します。',
    ...
    guidesCta: 'ガイドを見る',
    emotionsLabel: '11の感情ページ',
    emotionsDescription: '喜び、感謝、満足、寂しさ、不安などの違いと、日記でどう言葉にするかを整理した辞書型ページです。',
    emotionsCta: '感情辞典を見る',
  ...
  zh: {
    ...
    sectionSubtitle: '不做松散博客，而是围绕情绪日记的使用场景和11种情绪分类建立内容页。',
    ...
    guidesCta: '查看指南',
    emotionsLabel: '11个情绪词条',
    emotionsDescription: '词条式页面帮助用户区分喜悦、感谢、满足、孤独、焦虑等情绪，并学习如何写进日记里。',
    emotionsCta: '查看情绪词典',
...
export const emotions: Record<EmotionSlug, Record<Lang, LocalizedEmotion>> = {
  ...
  gratitude: {
    ko: {
      name: '감사',
      summary: '받은 것과 연결감을 알아차리며 마음이 따뜻해지는 상태입니다.',
      overview: '감사는 큰 도움을 받았을 때만 생기지 않습니다. 누군가의 작은 배려, 운 좋게 지나간 일, 스스로 버틴 하루에서도 조용히 올라옵니다.',
      signals: ['누군가가 떠오른다', '마음이 부드러워진다', '작게 보답하고 싶어진다'],
      journalTips: ['무엇을 받았다고 느꼈는지 적기', '그 일이 내 하루를 어떻게 바꿨는지 남기기', '감사를 표현할 방법을 한 줄로 써보기'],
      prompt: '오늘 내가 당연하게 넘기지 않아도 될 고마운 일은 무엇이었지?',
    },
    en: {
      name: 'Gratitude',
      summary: 'A warm state of noticing what you received or felt connected to.',
      overview: 'Gratitude does not only come from big favors. It often appears in small care, lucky timing, or realizing you made it through the day.',
      signals: ['A person or moment comes to mind', 'Your tone softens', 'You want to respond with care'],
      journalTips: ['Write what you felt you received', 'Note how it changed the day', 'Draft one small way to express it'],
      prompt: 'What did I receive today that I do not want to take for granted?',
    },
    ja: {
      name: '感謝',
      summary: '受け取ったものやつながりに気づき、心があたたかくなる状態です。',
      overview: '感謝は大きな助けだけでなく、小さな気遣い、よいタイミング、自分が一日を乗り切ったことにも現れます。',
      signals: ['誰かの顔が浮かぶ', '気持ちがやわらぐ', '少し返したくなる'],
      journalTips: ['何を受け取ったと感じたか書く', 'その出来事が一日をどう変えたか残す', '感謝を表す小さな方法を書く'],
      prompt: '今日、当たり前にしたくないありがたいことは何だった？',
    },
    zh: {
      name: '感谢',
      summary: '注意到自己收到的东西或连接感，心里变暖的状态。',
      overview: '感谢不只来自很大的帮助，也会出现在小小的照顾、刚好的时机，或意识到自己撑过了一天的时候。',
      signals: ['会想到某个人或某个瞬间', '语气变柔和', '想用一点行动回应'],
      journalTips: ['写下自己觉得收到了什么', '记录它怎样改变了今天', '写一个表达感谢的小方式'],
      prompt: '今天有什么值得我不把它当成理所当然？',
    },
  },
  satisfaction: {
    ko: {
      name: '만족',
      summary: '지금의 결과나 상태가 충분하다고 느끼는 안정된 긍정감입니다.',
      overview: '만족은 들뜬 기쁨보다 조용합니다. 목표를 완벽히 끝내지 않아도, 오늘 이 정도면 괜찮다고 느낄 때 나타납니다.',
      signals: ['마음이 덜 조급하다', '마무리감이 든다', '현재 상태를 받아들이기 쉽다'],
      journalTips: ['무엇이 충분하다고 느껴졌는지 적기', '더 욕심내고 싶은 부분과 이미 괜찮은 부분을 나누기', '오늘 유지하고 싶은 기준을 남기기'],
      prompt: '오늘 “이 정도면 괜찮다”라고 느낀 부분은 무엇이었지?',
    },
    en: {
      name: 'Satisfaction',
      summary: 'A steady positive feeling that the current result or state is enough.',
      overview: 'Satisfaction is quieter than excitement. It appears when something feels complete enough, even if it is not perfect.',
      signals: ['You feel less rushed', 'There is a sense of closure', 'It is easier to accept the present state'],
      journalTips: ['Write what felt sufficient', 'Separate what you still want from what is already okay', 'Note the standard you want to keep'],
      prompt: 'What felt “good enough” in a healthy way today?',
    },
    ja: {
      name: '満足',
      summary: '今の結果や状態を十分だと感じる、安定した前向きな感情です。',
      overview: '満足は高揚感より静かです。完璧でなくても、今日はこれでよいと思えた時に現れます。',
      signals: ['焦りが少なくなる', '一区切りついた感じがある', '今の状態を受け入れやすい'],
      journalTips: ['何が十分だと感じたか書く', 'もっと望む部分とすでによい部分を分ける', '保ちたい基準を残す'],
      prompt: '今日「これで十分」と健やかに思えたことは？',
    },
    zh: {
      name: '满足',
      summary: '觉得现在的结果或状态已经足够的稳定积极感。',
      overview: '满足比兴奋更安静。即使还不完美，只要觉得今天这样已经可以，它就会出现。',
      signals: ['不那么着急', '有完成或收尾感', '更容易接受当下状态'],
      journalTips: ['写下什么让你觉得足够', '区分还想要的部分和已经可以的部分', '记录想继续保留的标准'],
      prompt: '今天有什么让我健康地觉得“这样已经可以”？',
    },
  },
  loneliness: {
    ko: {
      name: '외로움',
      summary: '연결되고 싶은 마음이 채워지지 않아 마음이 비어 있는 상태입니다.',
      overview: '외로움은 혼자 있을 때만 생기지 않습니다. 사람들 사이에 있어도 이해받지 못한다고 느끼면 외로움이 올라올 수 있습니다.',
      signals: ['연락하고 싶은 사람이 떠오른다', '주변과 멀어진 느낌이 든다', '말을 해도 닿지 않는 것 같다'],
      journalTips: ['누구와 연결되고 싶었는지 적기', '혼자 있고 싶은 마음과 연결되고 싶은 마음을 구분하기', '내일 먼저 보낼 수 있는 짧은 메시지를 써보기'],
      prompt: '오늘 나는 누구에게 어떤 방식으로 닿고 싶었지?',
    },
    en: {
      name: 'Loneliness',
      summary: 'An empty feeling that appears when the need for connection is unmet.',
      overview: 'Loneliness does not only happen when you are physically alone. It can appear around people when you feel unseen or not understood.',
      signals: ['You think of someone you want to contact', 'You feel distant from the room', 'Speaking still does not feel like being heard'],
      journalTips: ['Write who or what you wanted to feel connected to', 'Separate wanting solitude from wanting connection', 'Draft one small message you could send'],
      prompt: 'Who did I want to reach today, and how?',
    },
    ja: {
      name: '寂しさ',
      summary: 'つながりたい気持ちが満たされず、心に空白を感じる状態です。',
      overview: '寂しさは一人の時だけではありません。人の中にいても、理解されていないと感じる時に現れます。',
      signals: ['連絡したい人が浮かぶ', '周囲から遠い感じがする', '話しても届いていない気がする'],
      journalTips: ['誰とつながりたかったか書く', '一人でいたい気持ちとつながりたい気持ちを分ける', '明日送れる短いメッセージを書く'],
      prompt: '今日は誰に、どんな形で届きたかった？',
    },
    zh: {
      name: '孤独',
      summary: '想要连接却没有被满足时出现的空落感。',
      overview: '孤独不只发生在一个人的时候。即使在人群里，如果觉得没人理解，也可能感到孤独。',
      signals: ['想到想联系的人', '觉得自己离周围很远', '说了话也像没有被听见'],
      journalTips: ['写下自己想和谁或什么连接', '区分想独处和想被连接的部分', '写一句明天可以先发出的短消息'],
      prompt: '今天我想以什么方式靠近谁？',
    },
  },
  anxiety: {
    ko: {
      name: '불안',
      summary: '아직 일어나지 않은 가능성을 대비하느라 마음이 긴장된 상태입니다.',
      overview: '불안은 미래를 미리 통제하려는 마음에서 자주 생깁니다. 위험을 알려주는 신호일 수도 있지만, 생각이 과열되면 현재를 좁게 만듭니다.',
      signals: ['최악의 경우를 반복해서 상상한다', '몸이 긴장하거나 가슴이 답답하다', '확인을 계속하고 싶어진다'],
      journalTips: ['실제로 확인된 사실과 예상한 걱정을 나누기', '내가 통제할 수 있는 행동 하나를 적기', '지금 당장 필요 없는 걱정은 내일로 미뤄보기'],
      prompt: '오늘 내 불안은 사실보다 어떤 가능성에 더 크게 반응했지?',
    },
    en: {
      name: 'Anxiety',
      summary: 'A tense state caused by preparing for possibilities that have not happened yet.',
      overview: 'Anxiety often comes from trying to control the future early. It can warn you about risk, but when it overheats, it narrows the present.',
      signals: ['You replay worst-case scenarios', 'Your body tightens or your chest feels heavy', 'You keep wanting more certainty'],
      journalTips: ['Separate confirmed facts from imagined outcomes', 'Write one action within your control', 'Move non-urgent worries to tomorrow'],
      prompt: 'What possibility did my anxiety react to more than the facts today?',
    },
    ja: {
      name: '不安',
      summary: 'まだ起きていない可能性に備えようとして、心が緊張する状態です。',
      overview: '不安は未来を先にコントロールしようとする時によく生まれます。リスクのサインにもなりますが、強すぎると現在を狭くします。',
      signals: ['最悪の場面を繰り返し想像する', '身体がこわばる、胸が重い', '何度も確認したくなる'],
      journalTips: ['確認できた事実と想像した心配を分ける', '自分ができる行動を一つ書く', '今不要な心配は明日に回す'],
      prompt: '今日の不安は、事実よりどんな可能性に反応していた？',
    },
    zh: {
      name: '焦虑',
      summary: '为了还没发生的可能性提前准备而紧绷的状态。',
      overview: '焦虑常来自想提前控制未来。它有时是在提醒风险，但如果过热，就会让当下变窄。',
      signals: ['反复想最坏情况', '身体紧绷或胸口发闷', '总想继续确认'],
      journalTips: ['把已确认的事实和想象的担心分开', '写下一个自己能控制的行动', '把不紧急的担心推迟到明天'],
      prompt: '今天我的焦虑更像是在对哪种可能性反应，而不是事实？',
    },
  },
  tiredness: {
    ko: {
...
export const features: Record<FeatureSlug, Record<Lang, LocalizedFeature>> = {
  ...
  'diary-to-poem': {
    ko: {
      title: '일기변환',
      description: '일기를 시적인, 감성적인, 다정한 등 원하는 스타일의 글로 바꾸는 기능 소개 페이지입니다.',
      intro: '같은 일기도 어떤 스타일로 표현하느냐에 따라 새로운 분위기로 읽힙니다. 일기변환 기능은 원본의 감정과 이야기를 살리면서 원하는 문체로 다시 표현해줍니다.',
      sections: [
        { heading: '원하는 스타일로 다시 표현', body: '시적인, 감성적인, 다정한 등 다양한 스타일 중 원하는 분위기를 골라 일기를 새롭게 바꿔볼 수 있습니다.' },
        { heading: '원본의 감정과 이야기 보존', body: '일기의 핵심 내용과 감정은 유지하면서 표현 방식만 바꿔, 나만의 목소리가 담긴 새로운 버전을 만듭니다.' },
        { heading: '같은 하루를 여러 방식으로 돌아보기', body: '하나의 일기를 여러 스타일로 변환해 그날의 기억을 다양한 분위기로 다시 읽고 간직할 수 있습니다.' },
      ],
      highlights: ['시적인·감성적인·다정한 등 다양한 스타일 지원', '원본의 감정과 내용을 살린 문체 변환', '같은 일기를 여러 분위기로 다시 감상'],
    },
    en: {
      title: 'Transform Your Diary',
      description: 'A feature for rewriting diary entries in styles such as poetic, emotional, and warm.',
      intro: 'The memory stays the same, but the mood can change with the way it is expressed. Diary transformation preserves the story and feelings while rewriting them in the style you choose.',
      sections: [
        { heading: 'Choose a style for your entry', body: 'Rewrite a diary in a style that fits the moment, from poetic and emotional to warm and gentle.' },
        { heading: 'Preserve the story and feelings', body: 'The transformation changes the expression while keeping the essential content and emotions of the original entry.' },
        { heading: 'Revisit one day in different moods', body: 'Transform the same diary into multiple styles and enjoy the memory from a new perspective each time.' },
      ],
      highlights: ['Choose from poetic, emotional, warm, and more styles', 'Preserve the original story and feelings', 'Revisit the same entry in different moods'],
    },
    ja: {
      title: '日記を詩に変換',
